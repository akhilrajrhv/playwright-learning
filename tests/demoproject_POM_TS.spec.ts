...
test("Swag Labs Test Cases" + dataobj.buy_product, async ({ page }) => {
    ...
    //Product listing page test data
    

    //Checkout page test data
   

    //Complete page test data
